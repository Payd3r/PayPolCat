...
public class Settings extends javax.swing.JFrame {
    ...
    public Settings() {
        ...
        if (!ClientHandler.getInstance().getIpServer().equals("") && ClientHandler.getInstance().getPort() != 0) {
            jTextField1.setText(ClientHandler.getInstance().getIpServer());
            jTextField2.setText(ClientHandler.getInstance().getPort() + "");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Imposta Server");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtPassw, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ClientHandler.getInstance().newConnection(jTextField1.getText(), jTextField2.getText(), txtUser.getText(), txtPassw.getText())) {
            try {
                Menu m = new Menu();
