...
//    }
    private void refreshTable(String area, String stazione) throws IOException, ParseException {
        ...
        model.setRowCount(0);
        List<Forecast> temp = DBManager.readForecast(Paths.get("../Data/ParametriClimatici.txt"));
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        try {
            AddNotes a = new AddNotes(cmbAreas.getSelectedItem().toString(), DatiCondivisi.getInstance().getOperatore().getStation(), date, time, wind, humidity, pressure, temperature, rainfall, glacierAltitude, massGlaciers);
