...
public class MenuOperatore extends javax.swing.JFrame {
    ...
    /**
     * Costruttore che crea l'oggetto della finestra dove si andrà ad aggiungere una rilevazione riempie la combobox con i relativi dati e popola la tabella con i dati salvati in precedenza
     *
     */
...
//    }
    ...
    private void createComboMonitoringStation() throws ClassNotFoundException, SQLException {
        ...
        for (int i = 0; i < monitoringStations.size(); i++) {
            if (maurifrocio == monitoringStations.get(i).getName()) {
